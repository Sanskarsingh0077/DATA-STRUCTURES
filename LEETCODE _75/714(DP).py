    ...
    def maxProfit(self, prices: List[int], fee: int) -> int:
        ...
        def solve(day,buy):
            ...
            if buy: #Buying: True
                ...
                sell = prices[day] - fee + solve(day + 1, True)  # sell and pay fee
        ...
        return solve(0,True) # Start on day 0, with ability to buy
        ...
        for i in range(1,n):
            cash = max(cash, hold+prices[i]-fee)  # Sell the stock at prices[i], pay fee
